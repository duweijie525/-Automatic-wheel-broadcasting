...
! function(e, t) {
	...
	var o = {
				...
				for (var a = Object(e[0]), i = 1; i < e.length; i += 1) {
					...
					if (void 0 !== s && null !== s)
						for (var r = Object.keys(Object(s)), n = 0, l = r.length; n < l; n += 1) {
							...
							void 0 !== p && p.enumerable && (o.isObject(a[d]) && o.isObject(s[d]) ? o.extend(a[d], s[d]) : !o.isObject(a[d]) &&
								o.isObject(s[d]) ? (a[d] = {}, o.extend(a[d], s[d])) : a[d] = s[d])
						}
				}
				return a
			}
		...
		l = {
			touch: s.Modernizr && !0 === s.Modernizr.touch || !!("ontouchstart" in s || s.DocumentTouch && document instanceof s
				.DocumentTouch),
	...
	d.prototype.on = function(e, t) {
		...
		for (var e = [], t = arguments.length; t--;) e[t] = arguments[t];
		var a, i, s, r = this;
		return "string" == typeof e[0] || Array.isArray(e[0]) ? (a = e[0], i = e.slice(1, e.length), s = r) : (a = e[0].events,
			i = e[0].data, s = e[0].context || r), (Array.isArray(a) ? a : a.split(" ")).forEach(function(e) {
	...
	var c = {
			updateSize: function() {
				...
				e = void 0 !== a.params.width ? a.params.width : i[0].clientWidth, t = void 0 !== a.params.height ? a.params.height :
					i[0].clientHeight, 0 === e && a.isHorizontal() || 0 === t && a.isVertical() || (e = e - parseInt(i.css(
						...
						parseInt(i.css("padding-bottom"), 10), o.extend(a, {
							width: e,
							height: t,
			...
			updateSlides: function() {
				...
				if (void 0 !== i) {
					...
					var T;
					t.slidesPerColumn > 1 && (T = Math.floor(d / t.slidesPerColumn) === d / e.params.slidesPerColumn ? d : Math.ceil(
							d / t.slidesPerColumn) * t.slidesPerColumn, "auto" !== t.slidesPerView && "row" === t.slidesPerColumnFill &&
					...
					0 === p.length && (p = [0]), 0 !== t.spaceBetween && (e.isHorizontal() ? s ? n.css({
							...
							slidesGrid: c,
							slidesSizesGrid: u
						}), d !== f && e.emit("slidesLengthChange"), p.length !== m && e.emit("snapGridLengthChange"), c.length !== g &&
			...
			updateProgress: function(e) {
				...
				0 === i ? (s = 0, r = !0, n = !0) : (r = (s = (e - t.minTranslate()) / i) <= 0, n = s >= 1), o.extend(t, {
					...
					"reachBeginning toEdge"), n && !d && t.emit("reachEnd toEdge"), (l && !r || d && !n) && t.emit("fromEdge"), t.emit(
					"progress", s)
			},
			...
			updateActiveIndex: function(e) {
				...
				if ((t = Math.floor(p / n.slidesPerGroup)) >= r.length && (t = r.length - 1), p !== l) {
					...
					o.extend(a, {
						...
						previousIndex: l,
						activeIndex: p
					}), a.emit("activeIndexChange"), a.emit("snapIndexChange"), d !== u && a.emit("realIndexChange"), a.emit(
						"slideChange")
				}
			},
		...
		f = {
			slideTo: function(e, t, a, i) {
				...
				return !(!s.allowSlideNext && f < s.translate && f < s.minTranslate() || !s.allowSlidePrev && f > s.translate &&
					f > s.maxTranslate() && (p || 0) !== r || (s.updateActiveIndex(r), c && -f === s.translate || !c && f === s.translate ?
						(n.autoHeight && s.updateAutoHeight(), s.updateSlidesClasses(), "slide" !== n.effect && s.setTranslate(f), 1) :
						(s.updateSlidesClasses(), s.emit("beforeTransitionStart", t, i), s.transitionStart(a), 0 === t || v.lteIE9 ? (
							s.setTransition(0), s.setTranslate(f), s.transitionEnd(a)) : (s.setTransition(t), s.setTranslate(f), s.animating ||
							(s.animating = !0, u.transitionEnd(function() {
								s && s.transitionEnd(a)
							}))), 0)))
			},
				...
				if (i.loop) {
					...
					t = parseInt(e(a.clickedSlide).attr("data-swiper-slide-index"), 10), i.centeredSlides ? n < a.loopedSlides - r /
						2 || n > a.slides.length - a.loopedSlides + r / 2 ? (a.loopFix(), n = s.children("." + i.slideClass +
							'[data-swiper-slide-index="' + t + '"]:not(.' + i.slideDuplicateClass + ")").eq(0).index(), o.nextTick(
							function() {
								a.slideTo(n)
		...
		m = {
			loopCreate: function() {
				...
				s.each(function(a, i) {
					var r = e(i);
					a < t.loopedSlides && d.push(i), a < s.length && a >= s.length - t.loopedSlides && l.push(i), r.attr(
		...
		w = function() {
			...
			if (a && (t.os = "windows", t.osVersion = a[2], t.windows = !0), i && !a && (t.os = "android", t.osVersion = i[2],
				...
				t.minimalUi = !t.webView && (n || o) && (1 * l[0] == 7 ? 1 * l[1] >= 1 : 1 * l[0] > 7) && d && d.getAttribute(
		...
		y = function(t) {
			var a = this,
				...
				r = a.touches,
				n = t;
			if (n.originalEvent && (n = n.originalEvent), i.isTouchEvent = "touchstart" === n.type, i.isTouchEvent || !("which" in
					n) || 3 !== n.which)
				...
				if (!(w.ios && s.iOSEdgeSwipeDetection && l <= s.iOSEdgeSwipeThreshold)) {
					if (o.extend(i, {
							...
							isScrolling: void 0,
							startMoving: void 0
						}), r.startX = l, r.startY = d, i.touchStartTime = o.now(), a.allowClick = !0, a.updateSize(), a.swipeDirection =
						void 0, s.threshold > 0 && (i.allowThresholdMove = !1), "touchstart" !== n.type) {
						var p = !0;
						e(n.target).is(i.formElements) && (p = !1), document.activeElement && e(document.activeElement).is(i.formElements) &&
							document.activeElement.blur(), p && n.preventDefault()
					}
					a.emit("touchStart", n)
				}
			}
		...
		x = function(t) {
			...
			if (l.originalEvent && (l = l.originalEvent), !i.isTouchEvent || "mousemove" !== l.type) {
				...
				if (i.isTouchEvent && s.touchReleaseOnEdges && !s.loop)
					...
					return;
				if (i.isTouchEvent && document.activeElement && l.target === document.activeElement && e(l.target).is(i.formElements))
					return i.isMoved = !0, void(a.allowClick = !1);
				if (i.allowTouchCallbacks && a.emit("touchMove", l), !(l.targetTouches && l.targetTouches.length > 1)) {
					if (r.currentX = "touchmove" === l.type ? l.targetTouches[0].pageX : l.pageX, r.currentY = "touchmove" === l.type ?
						l.targetTouches[0].pageY : l.pageY, void 0 === i.isScrolling) {
						var c;
						a.isHorizontal() && r.currentY === r.startY || a.isVertical() && r.currentX === r.startX ? i.isScrolling = !1 :
							(c = 180 * Math.atan2(Math.abs(r.currentY - r.startY), Math.abs(r.currentX - r.startX)) / Math.PI, i.isScrolling =
								a.isHorizontal() ? c > s.touchAngle : 90 - c > s.touchAngle)
					}
					if (i.isScrolling && a.emit("touchMoveOpposite", l), "undefined" == typeof startMoving && (r.currentX === r.startX &&
							r.currentY === r.startY || (i.startMoving = !0)), i.isTouched)
						if (i.isScrolling) i.isTouched = !1;
						else if (i.startMoving) {
						a.allowClick = !1, l.preventDefault(), s.touchMoveStopPropagation && !s.nested && l.stopPropagation(), i.isMoved ||
							(s.loop && a.loopFix(), i.startTranslate = a.getTranslate(), a.setTransition(0), a.animating && a.$wrapperEl.trigger(
								...
								!0 !== a.allowSlidePrev || a.setGrabCursor(!0), a.emit("sliderFirstMove", l)), a.emit("sliderMove", l), i.isMoved = !
							0;
						var u = a.isHorizontal() ? r.currentX - r.startX : r.currentY - r.startY;
						r.diff = u, u *= s.touchRatio, n && (u = -u), a.swipeDirection = u > 0 ? "prev" : "next", i.currentTranslate = u +
							i.startTranslate;
						var h = !0,
							v = s.resistanceRatio;
						if (s.touchReleaseOnEdges && (v = 0), u > 0 && i.currentTranslate > a.minTranslate() ? (h = !1, s.resistance &&
								(i.currentTranslate = a.minTranslate() - 1 + Math.pow(-a.minTranslate() + i.startTranslate + u, v))) : u < 0 &&
							i.currentTranslate < a.maxTranslate() && (h = !1, s.resistance && (i.currentTranslate = a.maxTranslate() + 1 -
								Math.pow(a.maxTranslate() - i.startTranslate - u, v))), h && (l.preventedByNestedSwiper = !0), !a.allowSlideNext &&
		...
		T = function(e) {
			...
			if (p.originalEvent && (p = p.originalEvent), a.allowTouchCallbacks && t.emit("touchEnd", p), a.allowTouchCallbacks = !
				...
				if (t.allowClick && (t.updateClickedSlide(p), t.emit("tap", p), u < 300 && c - a.lastClickTime > 300 && (a.clickTimeout &&
						clearTimeout(a.clickTimeout), a.clickTimeout = o.nextTick(function() {
							t && t.emit("click", p)
						}, 300)), u < 300 && c - a.lastClickTime < 300 && (a.clickTimeout && clearTimeout(a.clickTimeout), t.emit(
						"doubleTap", p))), a.lastClickTime = o.now(), o.nextTick(function() {
						t && (t.allowClick = !0)
				...
				if (h = i.followFinger ? r ? t.translate : -t.translate : -a.currentTranslate, i.freeMode) {
					...
					if (i.freeModeMomentum) {
						if (a.velocities.length > 1) {
							...
							t.velocity = m / g, t.velocity /= 2, Math.abs(t.velocity) < i.freeModeMinimumVelocity && (t.velocity = 0), (g >
								150 || o.now() - v.time > 300) && (t.velocity = 0)
						} else t.velocity = 0;
						...
						i.freeModeMomentumBounce && T ? (t.updateProgress(x), t.setTransition(b), t.setTranslate(y), t.transitionStart(),
							t.animating = !0, n.transitionEnd(function() {
								t && a.allowMomentumBounce && (t.emit("momentumBounce"), t.setTransition(i.speed), t.setTranslate(x), n.transitionEnd(
									function() {
										t && t.transitionEnd()
									}))
					...
					for (var M = 0, z = t.slidesSizesGrid[0], P = 0; P < l.length; P += i.slidesPerGroup) void 0 !== l[P + i.slidesPerGroup] ?
						h >= l[P] && h < l[P + i.slidesPerGroup] && (M = P, z = l[P + i.slidesPerGroup] - l[P]) : h >= l[P] && (M = P, z =
			...
			events: {
				attachEvents: function() {
					...
					var r = "container" === t.touchEventsTarget ? i : s,
						n = !!t.nested;
					if (v.ie) r.addEventListener(a.start, e.onTouchStart, !1), (l.touch ? r : document).addEventListener(a.move, e.onTouchMove,
						n), (l.touch ? r : document).addEventListener(a.end, e.onTouchEnd, !1);
					else {
						if (l.touch) {
							...
							"mousedown", e.onTouchStart, !1), document.addEventListener("mousemove", e.onTouchMove, n), document.addEventListener(
				...
				detachEvents: function() {
					var e = this,
						...
						n = !!t.nested;
					if (v.ie) r.removeEventListener(a.start, e.onTouchStart, !1), (l.touch ? r : document).removeEventListener(a.move,
						e.onTouchMove, n), (l.touch ? r : document).removeEventListener(a.end, e.onTouchEnd, !1);
					else {
						if (l.touch) {
							var o = !("onTouchStart" !== a.start || !l.passiveListener || !t.passiveListeners) && {
								passive: !0,
							...
							"mousedown", e.onTouchStart, !1), document.removeEventListener("mousemove", e.onTouchMove, n), document.removeEventListener(
							"mouseup", e.onTouchEnd, !1))
			...
			classes: {
				addClasses: function() {
					var e = this,
						...
						r = e.$el,
						n = [];
					n.push(a.direction), a.freeMode && n.push("free-mode"), l.flexbox || n.push("no-flexbox"), a.autoHeight && n.push(
							"autoheight"), i && n.push("rtl"), a.slidesPerColumn > 1 && n.push("multirow"), w.android && n.push("android"),
						w.ios && n.push("ios"), (s.navigator.pointerEnabled || s.navigator.msPointerEnabled) && n.push("wp8-" + a.direction),
				...
				preloadImages: function() {
					...
					for (var t = 0; t < e.imagesToLoad.length; t += 1) {
						...
						e.loadImage(a, a.currentSrc || a.getAttribute("src"), a.srcset || a.getAttribute("srcset"), a.sizes || a.getAttribute(
							"sizes"), !0, function() {
							void 0 !== e && null !== e && e && (void 0 !== e.imagesLoaded && (e.imagesLoaded += 1), e.imagesLoaded ===
		...
		P = function(t) {
			function a() {
				...
				var u = o.extend({}, C);
				c.useModulesParams(u), c.params = o.extend({}, u, z, d), c.originalParams = o.extend({}, c.params), c.passedParams =
					o.extend({}, d);
				var h = e(c.params.el);
				if (n = h[0]) {
					if (h.length > 1) {
		...
		A = {
			handle: function(e) {
				...
				if (!(a.shiftKey || a.altKey || a.ctrlKey || a.metaKey || document.activeElement && document.activeElement.nodeName &&
		...
		N = {
			...
			enable: function() {
				...
				var a = t.$el;
				return "container" !== t.params.mousewheel.eventsTarged && (a = e(t.params.mousewheel.eventsTarged)), a.on(N.event,
			...
			disable: function() {
				...
				if (!t.mousewheel.enabled) return !1;
				var a = t.$el;
				return "container" !== t.params.mousewheel.eventsTarged && (a = e(t.params.mousewheel.eventsTarged)), a.off(N.event,
		...
		R = {
			update: function() {
				...
				if (a.el && t.pagination.el && t.pagination.$el && 0 !== t.pagination.$el.length) {
					...
					if (t.params.loop ? ((i = Math.ceil((t.activeIndex - t.loopedSlides) / t.params.slidesPerGroup)) > s - 1 - 2 * t
							.loopedSlides && (i -= s - 2 * t.loopedSlides), i > n - 1 && (i -= n), i < 0 && "bullets" !== t.params.paginationType &&
							(i = n + i)) : i = void 0 !== t.snapIndex ? t.snapIndex : t.activeIndex || 0, "bullets" === a.type && t.pagination
						...
						if (a.dynamicBullets && (t.pagination.bulletSize = o.eq(0)[t.isHorizontal() ? "outerWidth" : "outerHeight"](!0),
								r.css(t.isHorizontal() ? "width" : "height", 5 * t.pagination.bulletSize + "px")), o.removeClass(a.bulletActiveClass +
								" " + a.bulletActiveClass + "-next " + a.bulletActiveClass + "-next-next " + a.bulletActiveClass + "-prev " +
								a.bulletActiveClass + "-prev-prev"), r.length > 1) o.each(function(t, s) {
							var r = e(s);
							r.index() === i && (r.addClass(a.bulletActiveClass), a.dynamicBullets && (r.prev().addClass(a.bulletActiveClass +
								"-prev").prev().addClass(a.bulletActiveClass + "-prev-prev"), r.next().addClass(a.bulletActiveClass +
								"-next").next().addClass(a.bulletActiveClass + "-next-next")))
						});
						else {
							var l = o.eq(i);
							l.addClass(a.bulletActiveClass), a.dynamicBullets && (l.prev().addClass(a.bulletActiveClass + "-prev").prev().addClass(
								a.bulletActiveClass + "-prev-prev"), l.next().addClass(a.bulletActiveClass + "-next").next().addClass(a.bulletActiveClass +
								"-next-next"))
						}
						if (a.dynamicBullets) {
					...
					if ("fraction" === a.type && (r.find("." + a.currentClass).text(i + 1), r.find("." + a.totalClass).text(n)),
						"progressbar" === a.type) {
						var p = (i + 1) / n,
							c = p,
							u = 1;
						t.isHorizontal() || (u = p, c = 1), r.find("." + a.progressbarFillClass).transform("translate3d(0,0,0) scaleX(" +
							c + ") scaleY(" + u + ")").transition(t.params.speed)
					}
					"custom" === a.type && a.renderCustom ? (r.html(a.renderCustom(t, i + 1, n)), t.emit("paginationRender", t, r[0])) :
		...
		F = {
			...
			updateSize: function() {
				...
				if (e.params.scrollbar.el && e.scrollbar.el) {
					...
					s = "auto" === e.params.scrollbar.dragSize ? r * n : parseInt(e.params.scrollbar.dragSize, 10), e.isHorizontal() ?
						...
						.scrollbarHide && (i[0].style.opacity = 0), o.extend(t, {
							trackSize: r,
							divider: n,
							moveDivider: l,
							dragSize: s
			...
			onDragEnd: function(e) {
				...
				t.scrollbar.isTouched && (t.scrollbar.isTouched = !1, a.hide && (clearTimeout(t.scrollbar.dragTimeout), t.scrollbar
					.dragTimeout = o.nextTick(function() {
			...
			init: function() {
				...
				if (t.params.scrollbar.el) {
					...
					0 === d.length && (d = e('<div class="swiper-scrollbar-drag"></div>'), n.append(d)), t.scrollbar.dragEvents = !1 !==
						t.params.simulateTouch || l.touch ? s : {
							start: "mousedown",
							move: "mousemove",
							end: "mouseup"
						}, o.extend(a, {
		...
		q = {
			setTransform: function(t, a) {
				...
				if (l || d ? (l = l || "0", d = d || "0") : i.isHorizontal() ? (l = o, d = "0") : (d = o, l = "0"), l = l.indexOf(
					...
					"%" : d * a + "px", "undefined" != typeof pOpacity && null !== c) {
		...
		U = {
			...
			onGestureStart: function(t) {
				...
				s.$slideEl && s.$slideEl.length || (s.$slideEl = e(this), 0 === s.$slideEl.length && (s.$slideEl = a.slides.eq(a.activeIndex)),
					s.$imageEl = s.$slideEl.find("img, svg, canvas"), s.$imageWrapEl = s.$imageEl.parent("." + i.containerClass), s
					.maxRatio = s.$imageWrapEl.attr("data-swiper-zoom") || i.maxRatio, 0 !== s.$imageWrapEl.length) ? (s.$imageEl.transition(
					0), a.zoom.isScaling = !0) : s.$imageEl = void 0
			},
			onGestureChange: function(e) {
				...
				s.$imageEl && 0 !== s.$imageEl.length && (l.gestures ? t.zoom.scale = e.scale * i.currentScale : i.scale = s.scaleMove /
			...
			onGestureEnd: function(e) {
				var t = this,
					...
					i = t.zoom,
					s = i.gesture;
				!l.gestures && ("touchend" !== e.type || "touchend" === e.type && e.changedTouches.length < 2) || s.$imageEl && 0 !==
					s.$imageEl.length && (i.scale = Math.max(Math.min(i.scale, s.maxRatio), a.minRatio), s.$imageEl.transition(t.params
							.speed).transform("translate3d(0,0,0) scale(" + i.scale + ")"), i.currentScale = i.scale, i.isScaling = !1, 1 ===
						i.scale && (s.$slideEl = void 0))
			},
			...
			onTouchMove: function(e) {
				...
				if (i.$imageEl && 0 !== i.$imageEl.length && (t.allowClick = !1, s.isTouched && i.$slideEl)) {
					s.isMoved || (s.width = i.$imageEl[0].offsetWidth, s.height = i.$imageEl[0].offsetHeight, s.startX = o.getTranslate(
						i.$imageWrapEl[0], "x") || 0, s.startY = o.getTranslate(i.$imageWrapEl[0], "y") || 0, i.slideWidth = i.$slideEl[
			...
			enable: function() {
				...
				if (!a.enabled) {
					...
					l.gestures ? (i.on("gesturestart", a.onGestureStart, s), i.on("gesturechange", a.onGestureChange, s), i.on(
			...
			disable: function() {
				...
				if (a.enabled) {
					...
					l.gestures ? (i.off("gesturestart", a.onGestureStart, s), i.off("gesturechange", a.onGestureChange, s), i.off(
			...
			init: function() {
				...
				if (e.params.history) {
					if (!s.history || !s.history.pushState) return e.params.history.enabled = !1, void(e.params.hashNavigation.enabled = !
						0);
					var t = e.history;
					t.initialized = !0, t.paths = ie.getPathValues(), (t.paths.key || t.paths.value) && (t.scrollToSlide(0, t.paths.value,
			...
			setTranslate: function() {
				...
				for (var f = 0; f < r.length; f += 1) {
					...
					if (y <= 1 && y > -1 && (h = 90 * g + 90 * y, l && (h = 90 * -g - 90 * y)), m.transform(S), p.slideShadows) {
						...
						0 === C.length && (C = e('<div class="swiper-slide-shadow-' + (c ? "left" : "top") + '"></div>'), m.append(C)),
							0 === M.length && (M = e('<div class="swiper-slide-shadow-' + (c ? "right" : "bottom") + '"></div>'), m.append(
		...
		ue = {
			...
			on: {
				beforeInit: function() {
					var e = this;
					"cube" === e.params.effect && (e.classNames.push(e.params.containerModifierClass + "cube"), e.classNames.push(e.params
						.containerModifierClass + "3d"), o.extend(e.params, {
						slidesPerView: 1,
						slidesPerColumn: 1,
						slidesPerGroup: 1,
						watchSlidesProgress: !0,
		...
		he = {
			...
			setTransition: function(t) {
				var a = this,
					...
					s = a.activeIndex,
					r = a.$wrapperEl;
				if (i.transition(t).find(
						".swiper-slide-shadow-top, .swiper-slide-shadow-right, .swiper-slide-shadow-bottom, .swiper-slide-shadow-left")
					.transition(t), a.params.virtualTranslate && 0 !== t) {
					var n = !1;
		...
		ve = {
			...
			on: {
				beforeInit: function() {
					var e = this;
					"flip" === e.params.effect && (e.classNames.push(e.params.containerModifierClass + "flip"), e.classNames.push(e.params
						.containerModifierClass + "3d"), o.extend(e.params, {
						slidesPerView: 1,
						slidesPerColumn: 1,
						slidesPerGroup: 1,
		...
		fe = {
			setTranslate: function() {
				for (var t = this, a = t.width, i = t.height, s = t.slides, r = t.$wrapperEl, n = t.slidesSizesGrid, o = t.params
						...
						u = o.depth, h = 0, f = s.length; h < f; h += 1) {
					var m = s.eq(h),
						g = n[h],
					...
					if (m.transform(S), m[0].style.zIndex = 1 - Math.abs(Math.round(b)), o.slideShadows) {
						...
						0 === C.length && (C = e('<div class="swiper-slide-shadow-' + (l ? "left" : "top") + '"></div>'), m.append(C)),
							0 === M.length && (M = e('<div class="swiper-slide-shadow-' + (l ? "right" : "bottom") + '"></div>'), m.append(
